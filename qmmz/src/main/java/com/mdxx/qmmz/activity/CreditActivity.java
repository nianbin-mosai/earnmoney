...
public class CreditActivity extends Activity {
	...
	protected void initNavigationBar() {
		...
		mNavigationBar.setLayoutParams(new LayoutParams(
		...
		RelativeLayout.LayoutParams lp = (RelativeLayout.LayoutParams) mTitle
				.getLayoutParams();
		...
		RelativeLayout.LayoutParams shareLp = (RelativeLayout.LayoutParams) mShare
				.getLayoutParams();
