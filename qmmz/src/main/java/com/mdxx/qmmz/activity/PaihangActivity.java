...
public class PaihangActivity extends BaseActivity implements OnClickListener {
	...
	private void getpaihang() {
		...
		InterfaceTool.Networkrequest(this, queue, null, paihangurl, new Response.Listener<JSONObject>() {
	...
	private void initHeadView() {
		View view = getLayoutInflater().inflate(R.layout.paihang_headview, null);
	...
	class PaihangAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				convertView = getLayoutInflater().inflate(R.layout.linnear_paihang, null);
			...
			imageLoader.displayImage(paihang.getHeadimgurl(), holder.image_head, options, null);
