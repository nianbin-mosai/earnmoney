...
public class ForgetPasswordActivity extends BaseActivity {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btnGetCode:
                ...
                AppAction.getVerifyCode(mContext,etPhoneNumber.getText().toString(),"",new HttpResponseHandler(mContext,HttpResponse.class,ForgetPasswordActivity.this) {
                    @Override
    ...
    private void submit() {
        ...
        AppAction.checkVerifyCode(mContext, etPhoneNumber.getText().toString(), etCode.getText().toString(),"", new HttpResponseHandler(mContext,HttpResponse.class,ForgetPasswordActivity.this) {
            @Override
            public void onResponeseSucess(int statusCode, HttpResponse response, String responseString) {
                AppAction.forgetPassword(mContext,etPhoneNumber.getText().toString(), HexUtil.getEncryptedPwd(etPassword.getText().toString()),etCode.getText().toString(),UserPF.getInstance().getLogId(), new HttpResponseHandler(mContext, HttpResponse.class, ForgetPasswordActivity.this) {
                    @Override
                    public void onResponeseSucess(int statusCode, HttpResponse response, String responseString) {
