 ...
 * 2、后退刷新方法修复。
 * 3、将栈内Activity对象改为DuibaActivity。
 */
/**
 * Version 1.0.3
 * @author duiba fxt
...
public class DuibaActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (activityStack == null) {
            activityStack = new Stack<DuibaActivity>();
        }
        ...
        mWebView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onReceivedTitle(WebView view, String title) {
                DuibaActivity.this.onReceivedTitle(view, title);
            }
        });
    ...
    protected void initView() {
        ...
        LinearLayout.LayoutParams mLayoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, height50dp);
    ...
    protected void initNavigationBar(){
        ...
        mNavigationBar.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT,dp20));
    ...
    protected boolean shouldOverrideUrlByDuiba(WebView view, String url) {
        ...
        if (url.contains("dbnewopen")) { // 新开页面
            Intent intent = new Intent();
            intent.setClass(DuibaActivity.this, DuibaActivity.this.getClass());
